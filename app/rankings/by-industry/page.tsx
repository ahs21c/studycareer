          ...
          return (
            <div key={ind.industry} style={{
              ...
              <div>
                ...
                <div style={{ fontSize: 11, color: '#9ca3af' }}>{sharePct}% of total</div>
              </div>
              <div style={{ textAlign: 'right' }}>
                <div style={{ fontSize: 12.5, fontWeight: 500 }}>{ind.approvals.toLocaleString()}</div>
              </div>
              <div style={{ textAlign: 'right' }}>
                <div style={{ fontSize: 12.5, color: '#6b7280' }}>{ind.companies.toLocaleString()}</div>
              </div>
