...
function toMajorLabel(s: string) {
  ...
  return (
    <div>
      ...
      <div style={{ padding: '12px 14px', background: '#f9fafb', border: '0.5px solid #f3f4f6', borderRadius: 8, fontSize: 11, color: '#9ca3af', lineHeight: 1.65 }}>
        Data extracted from PERM green card filings submitted to the U.S. Department of Labor, where employers listed the foreign worker's institution of education. FY2021–2024 certified cases only. Trends shown by relative frequency, not absolute counts.
      </div>
    </div>
  )
}
